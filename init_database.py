...
from services.init_database.migrate_database import InitDbMigrateDatabase
...
init_db_migrate_database = InitDbMigrateDatabase()
init_db_migrate_database.write_migrate_database()
